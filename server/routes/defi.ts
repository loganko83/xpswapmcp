    ...
    const farms = [
      {
        ...
        stakingToken: {
          symbol: "XP-USDT LP",
          name: "XP-USDT Liquidity Pool Token",
          address: "0x1234567890123456789012345678901234567890",
          decimals: 18,
          logoUrl: "/lp-token.png"
        },
        rewardToken: {
          symbol: "XP",
          name: "Xphere",
      ...
      },
      {
        ...
        stakingToken: {
          symbol: "XP-ETH LP",
          name: "XP-ETH Liquidity Pool Token",
      ...
      },
      {
        ...
        stakingToken: {
          symbol: "BTC-USDT LP",
          name: "BTC-USDT Liquidity Pool Token",
